...
export const sidebarMenu = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Add Employee', path: '/employees/new', exact: true, requiredPermissions: [PERMISSIONS.EMPLOYEE_CREATE, PERMISSIONS.USER_CREATE] },
  ...
  },
  {
    ...
    children: [
      { label: 'Project Dashboard', path: '/project-tracker/dashboard', requiredPermissions: [PERMISSIONS.PROJECT_MANAGE, PERMISSIONS.PROJECT_CREATE, PERMISSIONS.PROJECT_UPDATE, PERMISSIONS.ISSUE_UPDATE] },
      { label: 'Projects', path: '/project-tracker/projects', requiredPermissions: [PERMISSIONS.PROJECT_MANAGE, PERMISSIONS.PROJECT_CREATE, PERMISSIONS.PROJECT_UPDATE] },
      { label: 'Create Project', path: '/project-tracker/create', exact: true, requiredPermissions: [PERMISSIONS.PROJECT_CREATE, PERMISSIONS.PROJECT_MANAGE] },
      { label: 'Sprints', path: '/project-tracker/sprints', requiredPermissions: [PERMISSIONS.PROJECT_MANAGE, PERMISSIONS.SPRINT_CREATE, PERMISSIONS.SPRINT_UPDATE] },
      { label: 'Backlog', path: '/project-tracker/backlog', requiredPermissions: [PERMISSIONS.PROJECT_MANAGE, PERMISSIONS.ISSUE_UPDATE] },
      { label: 'Kanban Board', path: '/project-tracker/board', requiredPermissions: [PERMISSIONS.PROJECT_MANAGE, PERMISSIONS.ISSUE_UPDATE] },
      { label: 'Issues', path: '/project-tracker/issues', requiredPermissions: [PERMISSIONS.ISSUE_CREATE, PERMISSIONS.ISSUE_UPDATE] },
      { label: 'Reports', path: '/project-tracker/reports', requiredPermissions: [PERMISSIONS.REPORT_VIEW] },
    ],
  },
  {
    id: 'crm',
  ...
  },
  {
    ...
    children: [
      { label: 'User Management', path: '/admin/users', requiredRoles: ADMIN_ROLES, requiredPermissions: [PERMISSIONS.USER_VIEW, PERMISSIONS.USER_CREATE, PERMISSIONS.USER_UPDATE] },
